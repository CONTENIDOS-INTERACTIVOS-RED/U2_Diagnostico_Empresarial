        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde una mirada estratégica, comprender cómo está organizada una empresa por dentro es clave para mejorar su rendimiento y adaptabilidad. En esta unidad, se sumergirá en el análisis de factores internos como la estructura organizacional, el talento humano, la cultura empresarial y los procesos estratégicos. Cada uno de estos componentes influye en la capacidad de la empresa para responder a los desafíos del entorno y alcanzar sus metas.
              p #[b ¡Prepárese para fortalecer sus competencias como analista empresarial y transformar la realidad interna de las organizaciones!]
